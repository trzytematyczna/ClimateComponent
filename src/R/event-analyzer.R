...
#* @post /events 
events<-function(timeline, event_min_prob = 0.12, event_min_length = 2){
...
#* To be removed / Returns events (same as event function) with highlighted trends: colors signifying increasing/decreasing/same trend
#* @param date_topic_prob
#* @param event_min_length Minimum of length of the event in units in accordance with the aggregation unit of the input data (day/week/month)
#* @param event_min_prob Minimum probability that event must have
#* @post /trends 
